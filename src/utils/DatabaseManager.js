...
class DatabaseManager {
  ...
  static setAiModelToLocalStorage(aiModel){
    aiModel.save(process.env.REACT_APP_LOCALSTORAGE_MODEL_PATH_TF);
  }
  ...
  static setAiModel(aiModel) {
    this.setAiModelToLocalStorage(aiModel);
  ...
  static getAiModelPartFromFirebaseToLocalStorage(part){
    ...
    firebase.database().ref("ai_manager").child(part).get().then(function(snapshot) {
